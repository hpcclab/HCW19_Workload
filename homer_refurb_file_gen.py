...
Workload_duration=24.5#JUST FOR PLOTTING
TIME_UNIT=720 #60 for minute and 3600 for second
NUM_TASKS=7000 # to generate 2500 useful tasks (in fact 2700 tasks)
...
#        print "%.2f"%gammaDist(1250, 0.1)
    ...
    arrivalParams = (NUM_TASKS, # numTasks for ~26.5 hours
                     ...
                     4, # numPriority
                     4, # numPrecedence
                     (0.5,0.75), # baseRateRange for the special-purpose tasks
                     (1.25,1.5), # highRateRange for the special-purpose tasks                            
                     (3*TIME_UNIT,5*TIME_UNIT), # base interval for the special-purpose tasks
                     #(16*TIME_UNIT,19*TIME_UNIT),
                     (.5*TIME_UNIT,1.5*TIME_UNIT), # high interval for the special-purpose tasks
